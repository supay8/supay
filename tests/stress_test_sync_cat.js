...
export const options = {
  stages: [
    ...
    { duration: '30s', target: 50 },  // Escala a 50 usuarios concurrentes (carga media)
...
export default function () {
  ...
  const POS_ID = '3d05d2fb-9072-481b-98e0-575c253ead56';

  const url = `${BASE_URL}/siat/sincronizar/${COMPANY_ID}/${POS_ID}`;
